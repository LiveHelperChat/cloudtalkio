...
<ul>
    ...
    <?php if (class_exists('\erLhcoreClassExtensionElasticsearch')) : ?>
        <li><a href="<?php echo erLhcoreClassDesign::baseurl('cloudtalkio/elastichistory')?>"><span class="material-icons">call</span><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('cloudtalkio/admin','Elastic history');?></a></li>
    <?php endif; ?>
