...
<div class="row pb-2">
    <div class="col-2 me-0 pe-0 pt-2">
...
<div class="row">
    <div class="col-10 offset-2">
        ...
        <button type="button" id="cancel-phone-action-<?php echo $msg['id']?>" class="btn float-end btn-outline-secondary btn-sm" ><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('cloudtalkio/admin','Cancel')?></button>
        <?php endif; ?>
    </div>
</div>
