    ...
    public static function callListExport($chats, $params = array())
    {
        ...
        $chatArray = array(
            array(
                ...
                \erTranslationClassLhTranslation::getInstance()->getTranslation('cloudtalkio/admin', 'Waiting time [s]'),
                \erTranslationClassLhTranslation::getInstance()->getTranslation('cloudtalkio/admin', 'Talking time [s]'),
                \erTranslationClassLhTranslation::getInstance()->getTranslation('cloudtalkio/admin', 'Wrap up time [s]'),
